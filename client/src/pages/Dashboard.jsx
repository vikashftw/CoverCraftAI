...
import { 
  Sparkles, UserCircle2, Upload, FileText, AlertCircle, X, Check, ChevronDown, 
  Plus, Github, Linkedin, Twitter, Globe
} from 'lucide-react';
import { SiLeetcode } from 'react-icons/si';

// Mock user data (replace with actual Firebase/MongoDB data)
const mockUser = {
  name: "John Doe",
...
function Dashboard() {
  ...
  const [socials, setSocials] = useState(mockUser.socials);
  ...
  // Handle text changes with word count validation
              ...
              {showProfileMenu && (
                <div className="absolute right-0 mt-2 w-80 rounded-xl bg-black/95 backdrop-blur-xl border border-white/10 shadow-xl p-4 z-50">
                  <div className="flex items-center gap-3 mb-4 pb-4 border-b border-white/10">
                    ...
                    />
                    <div>
                      <h3 className="text-white font-semibold">{mockUser.name}</h3>
                  ...
                  <div className="mb-4 pb-4 border-b border-white/10">
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <button
                        onClick={() => setShowSocialEdit(!showSocialEdit)}
      ...
      <main className="relative container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          {resumes.length > 0 ? (
            ...
            <div className="text-center bg-white/5 rounded-xl p-8 backdrop-blur-sm border border-white/10">
              ...
              <p className="text-gray-400 mb-4">Please add a resume to begin creating your cover letter</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="relative">
            <div
              className={`absolute inset-0 rounded-xl transition-colors duration-300 ${
                isDraggingJob ? 'bg-blue-500/20 border-2 border-dashed border-blue-500/50' : ''
              }`}
              onDragOver={(e) => {
                e.preventDefault();
            ...
            <div className="bg-black/40 backdrop-blur-xl rounded-xl border border-white/10 p-6">
              <div className="flex items-center justify-between mb-4">
                ...
                <span className={`text-sm ${wordCount.job > 900 ? 'text-red-400' : 'text-gray-400'}`}>
                ...
                <label className="inline-block">
                  <input
                    ...
                    onChange={(e) => {
                      ...
                      if (file) handleFileDrop({ preventDefault: () => {}, dataTransfer: { files: [file] } }, 'job');
                    }}
                  />
          ...
          <div className="bg-black/40 backdrop-blur-xl rounded-xl border border-white/10 p-6">
            <div className="flex items-center justify-between mb-4">
              ...
              <span className={`text-sm ${wordCount.prompts > 900 ? 'text-red-400' : 'text-gray-400'}`}>
        ...
        <div className="mt-8 flex items-center justify-center gap-4">
          <div className="relative">
            ...
            >
              <option value="pdf" className="bg-gray-900">PDF Format</option>
              <option value="docx" className="bg-gray-900">DOCX Format</option>
              <option value="text" className="bg-gray-900">Text Format</option>
            </select>
